...
with open(args.train_path1, 'r') as train_file_1:
    df1 = pd.read_csv(train_file_1, sep="\t", error_bad_lines=False, header=None)                            # LHSAB train: /Users/lilykawaoto/Documents/GitHub/LING-L715/LHSAB/lhsab_train_binary.tsv
